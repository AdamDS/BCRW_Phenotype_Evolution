%% data_check_D.m
% [cout,str_out] = data_check_D(flag,str_data,data,compval,comparisons)
% Checks length, min after IPOP, & max of data.

function [cout,str_out] = data_check_D(flag,str_data,data,compval,comparisons,aipop), 
...
if length(compval)~=4,  
  ...
  if flag==1, 
    ...
    i = 2;
    cout(:,i) = data_check_min(data(aipop:end),compval(i));
