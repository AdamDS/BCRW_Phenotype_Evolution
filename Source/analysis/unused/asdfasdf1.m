%% get_max_onc_v_pop.m
% # orgs of largest cluster vs. population size
% OR
% do largest cluster within different boxes of different linear dimensions
% ADS 3*8*13
global SIMOPTS;
...
for mu = mutability, SIMOPTS.mu = mu;
  ...
  for run = SIMS
    ...
    density = zeros(sum(num_clusters),2); %indexed by j
    j = 0;
